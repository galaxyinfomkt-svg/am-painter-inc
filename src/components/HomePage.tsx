...
const allProjectPhotos = [
  ...
  { src: '/images/exterior-painting-hudson-ma-am-painter-inc.jpg', alt: 'Exterior painting in Hudson, MA — gambrel-roof home with blue siding and white trim by A&M Painter Inc', category: 'Exterior' },
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              {faqList.map((faq, idx) => (
                ...
                >
                  <h3 className="text-lg font-bold text-secondary mb-3 flex items-start gap-3" itemProp="name">
