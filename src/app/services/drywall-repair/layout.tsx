...
export const metadata: Metadata = {
  title: { absolute: 'Drywall Repair MA | Same-Week Service, 2026 Free Quote' },
  ...
  twitter: {
    ...
    description: `Professional drywall repair in Massachusetts. ${business.yearsInBusiness}+ years, expert patching, family-owned, EPA Lead-Safe.`,
