      ...
      <main id="main-content" className="pt-[124px]">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <span className="flex items-center gap-2 text-white bg-white/10 px-4 py-2 rounded-full text-sm"><CheckCircleIcon className="h-5 w-5 text-primary" />Invisible Repairs</span>
                  <span className="flex items-center gap-2 text-white bg-white/10 px-4 py-2 rounded-full text-sm"><StarIcon className="h-5 w-5 text-yellow-400" />Texture Matching</span>
                  <span className="flex items-center gap-2 text-white bg-white/10 px-4 py-2 rounded-full text-sm"><ShieldCheckIcon className="h-5 w-5 text-primary" />Water Damage Repair</span>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 shadow-2xl border border-white/20">
                ...
                <p className="text-white/80 text-sm mb-3">Drywall Repair in Massachusetts</p>
                <div className="bg-white rounded-lg overflow-hidden mx-auto w-full max-w-[420px]">
                  <LazyFormEmbed src={business.formEmbedUrl} formId="Mh6K2okib8bY2wNnjYYq" variant="drywall-repair-hero" height={580} />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-primary py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-white">
            <div>
              <p className="text-2xl font-bold">Walls need a fix?</p>
        ...
        {/* Reviews */}
        <ServiceDetails serviceSlug="drywall-repair" />
